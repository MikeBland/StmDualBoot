...
SRCS = usb.c usb_callbacks.c usb_descriptor.c main.c hardware.c dfu.c SerialLoader.c
...
m4in1: begin clean gccversion build_m4in1 sizeafter finished  copy_m4in1 end
...
build_m4in1: TARGETFLAGS= -DTARGET_GENERIC_F103_PA1
# Set the linker script
build_m4in1: LDFLAGS +=-T$(ST_LIB)/c_only_md_high_density.ld
build_m4in1: elf bin lss sym
copy_m4in1:
	@echo
	@echo "Copying to binaries folder"
	@echo
	cp $(TARGET).bin bootloader_only_binaries/m4in1.bin
	@echo
